...
namespace WebApi.FormsSvc {
    ...
    public partial class FormsFUN : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private System.Collections.Generic.List<WebApi.FormsSvc.InputsFUN> inputsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=1)]
        public System.Collections.Generic.List<WebApi.FormsSvc.InputsFUN> inputs {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="FormsSvc.IForms")]
    public interface IForms {
        ...
        WebApi.FormsSvc.ObtenerFormsResponse ObtenerForms(WebApi.FormsSvc.ObtenerFormsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IForms/ObtenerForms", ReplyAction="http://tempuri.org/IForms/ObtenerFormsResponse")]
        System.Threading.Tasks.Task<WebApi.FormsSvc.ObtenerFormsResponse> ObtenerFormsAsync(WebApi.FormsSvc.ObtenerFormsRequest request);
    }
    ...
    public partial class ObtenerFormsRequest {
        ...
        public WebApi.FormsSvc.ObtenerFormsRequestBody Body;
        
        public ObtenerFormsRequest() {
        }
        
        public ObtenerFormsRequest(WebApi.FormsSvc.ObtenerFormsRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ObtenerFormsResponse {
        ...
        public WebApi.FormsSvc.ObtenerFormsResponseBody Body;
        
        public ObtenerFormsResponse() {
        }
        
        public ObtenerFormsResponse(WebApi.FormsSvc.ObtenerFormsResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IFormsChannel : WebApi.FormsSvc.IForms, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FormsClient : System.ServiceModel.ClientBase<WebApi.FormsSvc.IForms>, WebApi.FormsSvc.IForms {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WebApi.FormsSvc.ObtenerFormsResponse WebApi.FormsSvc.IForms.ObtenerForms(WebApi.FormsSvc.ObtenerFormsRequest request) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<WebApi.FormsSvc.ObtenerFormsResponse> WebApi.FormsSvc.IForms.ObtenerFormsAsync(WebApi.FormsSvc.ObtenerFormsRequest request) {
            return base.Channel.ObtenerFormsAsync(request);
        }
        
        public System.Threading.Tasks.Task<WebApi.FormsSvc.ObtenerFormsResponse> ObtenerFormsAsync() {
            WebApi.FormsSvc.ObtenerFormsRequest inValue = new WebApi.FormsSvc.ObtenerFormsRequest();
            inValue.Body = new WebApi.FormsSvc.ObtenerFormsRequestBody();
            return ((WebApi.FormsSvc.IForms)(this)).ObtenerFormsAsync(inValue);
        }
    }
}
